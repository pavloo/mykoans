...
class AboutMethods < EdgeCase::Koan
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    ...
    wrong_number_of_arguments_regxep = %r{wrong number of arguments \(\d for \d\)}
    assert_match(wrong_number_of_arguments_regxep, exception.message)
  ...
  def test_calling_private_methods_with_an_explicit_receiver
    ...
    assert_match %r{private method .+}, exception.message
  end
